...
class Groupe extends PDO
{

    public function __construct()
    {
        // Constructeur de la classe Groupe qui hérite de la classe PDO pour la gestion de la base de données MySQL
        parent::__construct("mysql:host=localhost;dbname=cours_enligne", "root", "");
    }
